    ...
    <div className="max-h-screen max-w-xl px-[2rem] items-center flex flex-col justify-center">
      <div className="flex flex-col text-center mt-[6rem] mb-10">
        ...
        <div className="mt-2 flex gap-4 items-center justify-center max-w-md z-10">
          <Link href="">
            <a className="border-2 font-bold border-gray-600 bg-transparent text-gray-600 py-4 px-6 rounded-xl hover:bg-blue-700 hover:text-white hover:shadow-md hover:scale-90 hover:border-blue-700 transition duration-150 tracking-wide uppercase text-sm lg:text-lg">
              Get in Touch
            </a>
          </Link>
        </div>
